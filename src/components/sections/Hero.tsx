    ...
    <section id="home" className="pt-32 pb-24 md:pt-40 md:pb-32 px-6 min-h-[90vh] flex items-center bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-slate-900 mb-4 sm:mb-6 leading-tight">
            Java Developer <br/> & CS Student
          </h1>
          
          <p className="text-base sm:text-lg text-slate-600 max-w-lg mb-6 sm:mb-8 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
            <Link href="#contact" className="w-full sm:w-auto">
              <Button variant="primary" className="w-full gap-2 rounded-lg px-6 sm:px-8 py-3 sm:py-3.5 shadow-md border-0 bg-royal hover:bg-royal-dark text-white">
                Hire Me <ArrowRight className="w-4 h-4 ml-1" />
              </Button>
            </Link>
            <a href="/profile.png" download="profile.png" className="w-full sm:w-auto">
              <Button variant="outline" className="w-full gap-2 rounded-lg px-6 sm:px-8 py-3 sm:py-3.5 bg-white text-royal border-2 border-royal hover:bg-royal hover:text-white shadow-sm focus:ring-royal">
        ...
        <motion.div
          ...
          className="relative flex justify-center items-center mt-16 sm:mt-12 md:mt-0"
        >
          {/* Geometric Background Shape (Replicating the split circle) */}
          <div className="relative w-[260px] h-[260px] sm:w-[320px] sm:h-[320px] md:w-[400px] md:h-[400px] lg:w-[450px] lg:h-[450px] mb-8">
            {/* Top half circle */}
          ...
          <motion.div 
            ...
            className="absolute -bottom-6 md:-bottom-8 left-1/2 transform -translate-x-1/2 bg-white px-4 sm:px-6 py-2.5 sm:py-3.5 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] flex flex-col sm:flex-row items-center gap-2 sm:gap-4 z-30 whitespace-nowrap border border-slate-100"
          >
            <span className="text-[10px] sm:text-[11px] font-bold text-slate-900 tracking-wide uppercase">Follow me on:</span>
